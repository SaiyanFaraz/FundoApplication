...
class ReminderController: UIViewController {
    ...
    func fetchInitialNotes() {
        FireBaseNoteService.shared.fetchInitialReminderNotes { note, error in
            if error != nil{
    ...
    func fetchMoreNotes() {
        FireBaseNoteService.shared.fetchMoreReminderNotes { note, error in
...
extension ReminderController: DidAuthenticationCompleted{
...
extension ReminderController: UICollectionViewDataSource {
...
extension ReminderController: UICollectionViewDelegate {
